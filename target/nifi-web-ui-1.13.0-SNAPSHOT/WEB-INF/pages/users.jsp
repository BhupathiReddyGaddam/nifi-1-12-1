...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/nf-users-all.css?1.13.0-SNAPSHOT" type="text/css" />
...
<link rel="stylesheet" href="css/nf-common-ui.css?1.13.0-SNAPSHOT" type="text/css" />
        ...
        <script type="text/javascript" src="js/nf/users/nf-users-all.js?1.13.0-SNAPSHOT"></script>
