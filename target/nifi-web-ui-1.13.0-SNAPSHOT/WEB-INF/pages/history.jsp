...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/nf-history-all.css?1.13.0-SNAPSHOT" type="text/css" />
...
<link rel="stylesheet" href="css/nf-common-ui.css?1.13.0-SNAPSHOT" type="text/css" />
        ...
        <script type="text/javascript" src="js/nf/history/nf-history-all.js?1.13.0-SNAPSHOT"></script>
    </head>
    <body>
