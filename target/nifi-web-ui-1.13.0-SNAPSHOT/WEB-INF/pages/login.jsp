...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/nf-login-all.css?1.13.0-SNAPSHOT" type="text/css" />
...
<link rel="stylesheet" href="css/nf-common-ui.css?1.13.0-SNAPSHOT" type="text/css" />
        ...
        <script type="text/javascript" src="js/nf/login/nf-login-all.js?1.13.0-SNAPSHOT"></script>
    </head>
